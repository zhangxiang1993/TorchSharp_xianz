...
namespace TorchSharp
{
    ...
    namespace Modules
    {
        ...
        /// </summary>
        public sealed class InstanceNorm2d : torch.nn.Module<Tensor, Tensor>
        {
            ...
            public Parameter? bias {
                get {
                    var res = THSNN_InstanceNorm2d_bias(handle);
                    if (res == IntPtr.Zero) { torch.CheckForErrors(); }
            ...
            public Parameter? weight {
                get {
                    var res = THSNN_InstanceNorm2d_weight(handle);
                    if (res == IntPtr.Zero) { torch.CheckForErrors(); }
                    return (res == IntPtr.Zero) ? null : new Parameter(res);
                }
                set {
            ...
            public Tensor? running_mean {
                get {
                    var res = THSNN_InstanceNorm2d_get_mean(handle);
            ...
            public Tensor? running_var {
                get {
                    var res = THSNN_InstanceNorm2d_get_var(handle);
                    if (res == IntPtr.Zero) { torch.CheckForErrors(); return null; }
                    return new Tensor(res);
                }
                set {
            ...
            public Tensor? num_batches_tracked {
                get {
                    var res = THSNN_InstanceNorm2d_get_batches(handle);
                    if (res == IntPtr.Zero) { torch.CheckForErrors(); return null; }
                    return new Tensor(res);
                }
            }
            ...
            {
                THSNN_InstanceNorm2d_reset_stats(handle);
                torch.CheckForErrors();
            }
        ...
        public static partial class nn
        {
            ...
            public static InstanceNorm2d InstanceNorm2d(long features, double eps = 1e-05, double momentum = 0.1, bool affine = false, bool track_running_stats = false, Device? device = null, ScalarType? dtype = null)
            {
                unsafe {
                    ...
                    return new InstanceNorm2d(handle, boxedHandle).MoveModule<InstanceNorm2d>(device, dtype);
                }
            }
        }
    }
